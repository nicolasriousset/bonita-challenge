...
Welcome to the Bonita AI Agent Connector project!

## 🎯 For Evaluators

**Quick Path (15 minutes)**:
1. Read [FOR_EVALUATOR.md](FOR_EVALUATOR.md)
2. Run automated tests: `.\run-tests.ps1` (Windows) or `./run-tests.sh` (Linux/Mac)
3. Review [AI_USAGE_REPORT.md](AI_USAGE_REPORT.md)
...
Full navigation guide: [INDEX.md](INDEX.md)
...
**Ready to explore? Start with [FOR_EVALUATOR.md](FOR_EVALUATOR.md)!** 🚀
